...
def load_transforms(name):
    ...
    if _name == "cifar_sup":
        ...
        normalize = transforms.Normalize([0.4914, 0.4822, 0.4465], [0.2023, 0.1994, 0.2010])
        aug_transform = transforms.Compose([
            #transforms.RandomResizedCrop(32,scale=(0.390, 0.390), ratio=(1,1)),
            
            
            #transforms.RandomResizedCrop(32,scale=(0.1914, 0.1914), ratio=(1,1)),
            transforms.RandomResizedCrop(32,scale=(0.04, 1.0)),
...
#             transforms.RandomResizedCrop(32,scale=(0.765625, 0.765625),ratio=(1., 1.)),
        ...
        aug_transform = transforms.Compose([
            transforms.RandomResizedCrop(96, scale=(0.04, 1.0)),
            transforms.RandomHorizontalFlip(),
            transforms.RandomApply([transforms.ColorJitter(0.8, 0.8, 0.8, 0.2)], p=0.8),
            transforms.RandomGrayscale(p=0.2),
            GBlur(p=0.1),
